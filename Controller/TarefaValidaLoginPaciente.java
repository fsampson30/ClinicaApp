...
import br.com.sonus.sonuscliente.View.LoginActivity;

public class TarefaValidaLoginPaciente extends AsyncTask<Paciente, Void, String> {

    private LoginActivity context;
    private CaminhoServlets caminho = new CaminhoServlets();

    public TarefaValidaLoginPaciente(Context context){
    ...
    protected String doInBackground(Paciente... strings) {
        try {
            URLConnection conexao = new URL(caminho.getCaminho()+"/ServletValidaLoginPaciente").openConnection();
